...
const Footer = () => {
    return (
        <section className='flex sm:py-16 py-6 flex-col w-full bg-black mt-10'>



            <div class="mx-auto w-full max-w-screen-xl bg-black">
                <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                    <div>
                        <h2 class="mb-6 text-sm font-bold  uppercase text-black text-2xl">NollyBee</h2>
                    </div>
                    <div>
