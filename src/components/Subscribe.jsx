...
const Subscribe = () => {
  return (
    <div>
      <div class="mx-auto mt-32  px-6 sm:mt-12 w-full lg:px-8">
    <div
        class="relative isolate overflow-hidden bg-gray-800 px-6 py-24 shadow-2xl rounded-2xl sm:rounded-3xl sm:px-16 xl:py-32">
